...
<body>
    <div class="card">
        ...
        <div class="card-body">
            {{Form::open(['route' => 'admin.book_store', 'method' => 'POST', 'enctype'=>'multipart/form-data'])}}
                ...
                <div class="form-group">
                    <input type="number" name="number" placeholder="Enter Contact Number" class="form-control">
                </div><br>
                <div class="form-group">
